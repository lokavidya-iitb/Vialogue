package com.comp.iitb.vialogue.temp;
...
public class postmanCommunication {
    ...
    public static final String JSON_AUTH_GUEST_URL= "http://"+"ruralict.cse.iitb.ac.in/lokavidya"+ "/api/authenticate?google=false&username=user&password=user&idTokenString=werty";
    public static final String FEEDBACK_URL= "http://"+"ruralict.cse.iitb.ac.in/lokavidya"+ "/api/feedbacks";
    ...
    public static JSONArray okhttpgetVideoJsonArray(String URL, String xtoken){
       ...
       //okhttpAuth();
        ...
        Request request = new Request.Builder()
                .url(URL)
                .get()
                .addHeader("x-auth-token", "user:1473301249451:326ab0191a3b06068e573a5989f4b570")
                .addHeader("cache-control", "no-cache")
    ...
    public static JSONArray okhttpgetGuestVideoJsonArray(String URL){
        ...
        okhttpGuestAuth();
        Log.i("GuestVideoJsonArray", xAUTH_TOKEN);
        Log.i("OKHTTP","auth done inside getjson"+URL);
